      ...
      <div className="services-right-side">
        <div class="card1-services card-description-service">
          ...
          <div class="card-inner">
            Embark on a transformative digital voyage with our cutting-edge web
            development agency. Our journey begins by crafting captivating
            landing pages that captivate your audience's attention and leave a
            lasting impression. Through meticulous design and strategic content
            placement, we ensure your brand's unique story takes center stage.
          </div>
        </div>
        <div class="card2-services card-description-service">
          ...
          <div class="circle"></div>
          <div class="card-inner">
            Navigating the modern online landscape requires adaptability, which
            is why we meticulously tailor your website's mobile responsiveness.
        ...
        <div class="card3-services card-description-service">
          ...
          <div class="card-inner">
            ...
            your website's prominence, employing industry-leading strategies to
